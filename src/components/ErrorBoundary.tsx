      ...
      return (
        <div style={{ minHeight: '100vh', display: 'flex', alignItems: 'center', justifyContent: 'center', background: '#0a0a0c', color: '#fff', fontFamily: 'sans-serif', padding: '2rem' }}>
          <div style={{ maxWidth: 600, textAlign: 'center' }}>
            <h1 style={{ fontSize: '2rem', color: '#2dd4bf', marginBottom: '1rem' }}>Erreur de chargement</h1>
            <p style={{ color: '#aaa', marginBottom: '1rem' }}>{this.state.error?.message}</p>
            <button
              onClick={() => window.location.reload()}
              style={{ padding: '0.75rem 2rem', background: '#2dd4bf', color: '#0b0e10', border: 'none', borderRadius: '4px', cursor: 'pointer', fontWeight: 600 }}
            >
              Recharger la page
            </button>
          </div>
